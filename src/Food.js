...
mouse_out(){
    ...
    return (
        <div className='food' id='food'>
            ...
            !بيروت لاونج <br/>
                    بكل بساطة "دافعنا الأول هو رضاكم" , بيروت لاونج بيقدم أشهى الأطباق اللبنانية والمشاوي بالاضافة لسهرات يومية مميزة من الطرب والأجواء البيروتية الحلوة

                    و نرافقكم بكل لحظاتكم بخدمة البوفيهات الخارجية التي تلبي كافة المناسبات الخاصة والفعاليات التجارية
                <br/>
                <br/>
                <div>
                Beirut Lounge!<br/>
